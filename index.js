...
const { getConfig, generateTempConfigFile, unzipAndCopy, watchDownloadDirectory, openDownloadLinkInBrowser} = require('./util/util');
...
program
    ...
    .option('-c, --config', '查看配置文件', openDownloadLinkInBrowser)
